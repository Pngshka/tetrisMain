...
function addWorld() {
    ...
    var sphereMaterial = new THREE.MeshBasicMaterial({ color: 0xfffafa })
...
function createTree() {
    ...
    var treeMaterial = new THREE.MeshBasicMaterial({ color: 0x33ff33 });
    var offset;
    ...
    var trunkMaterial = new THREE.MeshBasicMaterial({ color: 0x00ff00 });
