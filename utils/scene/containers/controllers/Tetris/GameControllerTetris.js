...
import {ignoreNextStates, states} from "../../../examples/constants/statesGame";
...
// import { useEventListener } from "react-hook";
...
export default class GameControllerTetris {
  ...
  constructor(animationControllerTetris, data) {
    ...
    // useEventListener(".continuePlaying", "mousedown", this.setStopGame);
  };
